...
public class BasicHeuristicsService extends BasicService {
    ...
    protected String getHint(@NonNull ViewNode node) {
        ...
        hint = getBasicHeuristicHint(viewHint);
        if (hint != null) {
        ...
        hint = getBasicHeuristicHint(resourceId);
        if (hint != null) {
        ...
        if (text != null && className != null && className.toString().contains("EditText")) {
            hint = getBasicHeuristicHint(text.toString());
            if (hint != null) {
    ...
    @Nullable
    private String getBasicHeuristicHint(@Nullable String string) {
